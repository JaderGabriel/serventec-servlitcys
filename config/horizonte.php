...
return [
    ...
    */
    ...
    'map_display' => [
        ...
        /** UF com ≥ N municípios abre vista intermédia por mesorregião IBGE antes do detalhe municipal. */
        'meso_overview_threshold' => max(40, (int) env('HORIZONTE_MAP_MESO_THRESHOLD', 60)),
