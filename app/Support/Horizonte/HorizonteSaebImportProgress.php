...
final class HorizonteSaebImportProgress
{
    ...
    private const CACHE_KEY_FAILED = 'horizonte:saeb_import:last_failed';
    ...
    /**
     * Anos pendentes ordenados (ascendente) com o último falhado no fim — evita bloqueio num único ano.
     *
     * @param  list<int>  $allYears
     * @return list<int>
     */
