            ...
            [
                ...
                'commands' => [
                    ...
                    [
                        ...
                        'env' => [
                            'HORIZONTE_OBRAS_ENABLED',
                            'HORIZONTE_OBRAS_BASE_URL',
                            'HORIZONTE_OBRAS_CNPJ_FNDE',
                            'HORIZONTE_OBRAS_SITUACOES',
                            'HORIZONTE_OBRAS_ENRICH_FINANCE',
                            'HORIZONTE_OBRAS_SCHEDULE_ENABLED',
                        ],
                        'doc_anchor' => 'horizonte',
                        'details' => __('MVP: CNPJ FNDE; situações ≠ Concluída; IBGE via geometria; empenho/% físico opcional. Fase obras_sync no feed bimestral. Agendamento mensal staged.'),
                    ],
                    [
                        'name' => 'horizonte:canteiro-alerts',
                        'summary' => __('Canteiro — snapshot mensal de alertas só para municípios com consultoria activa.'),
                        'signature' => 'horizonte:canteiro-alerts {--dry-run} {--pdf}',
                        'examples' => [
                        ...
                        'env' => [
                            'HORIZONTE_OBRAS_ALERTS_ENABLED',
                            'HORIZONTE_OBRAS_ALERTS_PATH',
                            'HORIZONTE_OBRAS_ALERTS_DAY',
                            'HORIZONTE_OBRAS_ALERTS_TIME',
                            'HORIZONTE_OBRAS_SIMEC_URL',
                        ],
                        'doc_anchor' => 'horizonte',
                        'details' => __('Conta obras paralisadas/em execução/inacabadas apenas em cidades activas com hasDataSetup(). Grava JSON + PDF opcional (--pdf). Rotina mensal no schedule.'),
                    ],
                    [
