...
final class DocumentationCatalog
{
    ...
    public static function adminOnlyPaths(): array
    {
        return [
            ...
            'docs/PERFORMANCE.md',
            'docs/ESCALABILIDADE_INFRAESTRUTURA.md',
            'docs/COMANDOS_ARTISAN.md',
            'docs/PLANO_TESTES_UNITARIOS.md',
            'docs/QUALIFICACAO_SISTEMA_E_COBERTURA_TESTES.md',
            ...
            'docs/MONITOR_PULSE_E_SAUDE_MODULOS.md',
        ...
        $sections = [
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => __('Orquestração externa (n8n)'),
                        'path' => 'docs/ORQUESTRACAO_EXTERNA_N8N_E_FERRAMENTAS.md',
                        'hint' => __('Webhooks · Slack · Sentry · melhores práticas'),
                    ],
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        'label' => __('Pulse e saúde de módulos'),
                        'path' => 'docs/MONITOR_PULSE_E_SAUDE_MODULOS.md',
                        'hint' => __('Telemetria · nota A–F · Clio/CadÚnico'),
                    ],
                    ['label' => __('Qualificação e cobertura de testes'), 'path' => 'docs/QUALIFICACAO_SISTEMA_E_COBERTURA_TESTES.md', 'hint' => __('Tipo · porte · metas H0–H3')],
