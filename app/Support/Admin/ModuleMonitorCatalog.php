...
final class ModuleMonitorCatalog
{
    ...
    public static function modules(): array
    {
        return [
            ...
            [
                'id' => 'clio',
                'label' => __('Clio — coletas Educacenso'),
                'description' => __('Campanhas CSV, ingestão, análise, cruzamento i-Educar e BI Clio.'),
                'icon' => 'academic-cap',
                'accent' => 'violet',
                'group' => 'consultoria',
                ...
                'admin_route_fragment' => null,
                'sync_queue_anchor' => null,
                'pulse_prefixes' => ['clio:', 'http:route:clio.'],
                'sync_domains' => [],
            ],
            [
                'id' => 'geo',
            ...
            [
                'id' => 'public_data',
                'label' => __('Hub consultoria municipal'),
                'description' => __('Importações e verificação de fontes para municípios com Consultoria — não inclui o Horizonte nacional.'),
                'icon' => 'globe-alt',
                'accent' => 'emerald',
                'group' => 'sincronizacao',
                'admin_route' => 'admin.public-data.index',
                'admin_route_query' => null,
                'admin_route_fragment' => 'verificacao-oficial',
                'sync_queue_anchor' => null,
            ...
            [
                'id' => 'horizonte',
                'label' => __('Horizonte — mapa nacional'),
                'description' => __('Abastecimento bimestral, triád FUNDEB×Censo×SAEB, mapa GIS e hub de fases.'),
                'icon' => 'map',
                'accent' => 'teal',
                'group' => 'horizonte',
                ...
                'pulse_prefixes' => [
                    'horizonte:',
                    'http:route:dashboard.horizonte',
                    'http:route:admin.horizonte-import',
                ],
                'sync_domains' => [],
            ],
            [
