...
final class AdminSyncQueueIndexPresenter
{
    ...
    public static function pdfThemeCard(Collection $pdfCounts, string $pdfQueueName): array
    {
        ...
        return [
            ...
            'description' => __('Exportações do Diagnóstico na consultoria — worker de PDF dedicado.'),
            'icon' => 'document-text',
            'accent' => 'rose',
            'anchor' => 'fila-pdf',
    ...
    public static function horizonteThemeCard(array $hub): array
    {
        ...
        return [
            'id' => 'horizonte',
            'label' => __('Horizonte'),
            'description' => __('Abastecimento nacional do mapa (FUNDEB, Censo, SAEB, IBGE) — rotina bimestral, fora da fila admin-sync.'),
            'icon' => 'map',
            'accent' => 'indigo',
    ...
    private static function syncThemeDefinitions(string $syncQueueName): array
    {
        ...
        return [
            [
                ...
                'description' => __('VAAF, VAAT, VAAR e importações por município.'),
                'icon' => 'banknotes',
                'accent' => 'amber',
                'anchor' => 'fila-fundeb',
            ],
            [
                ...
                'description' => __('Série do Tesouro (CKAN) para Finanças → Tempo Real.'),
                'icon' => 'banknotes',
                'accent' => 'emerald',
                'anchor' => 'fila-funding',
            ...
            [
                ...
                'description' => __('Coordenadas e microdados para mapas e unidades.'),
                'icon' => 'map-pin',
                'accent' => 'sky',
                'anchor' => 'fila-geo',
            ],
            [
                ...
                'description' => __('Séries SAEB e IDEB (INEP) para Desempenho e Horizonte.'),
                'icon' => 'academic-cap',
                'accent' => 'violet',
            ...
            [
                ...
                'description' => __('CadÚnico / Cecad — sync nacional e snapshots municipais.'),
                'icon' => 'users',
                'accent' => 'fuchsia',
            ...
            [
                ...
                'description' => __('Schema, exportações NEE e tarefas do painel i-Educar.'),
                'icon' => 'circle-stack',
                'accent' => 'indigo',
                'anchor' => 'fila-ieducar',
            ],
