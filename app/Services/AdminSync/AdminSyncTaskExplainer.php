...
final class AdminSyncTaskExplainer
{
    public static function summary(AdminSyncTask $task): string
    {
        ...
        return match ($key) {
            ...
            'cadastro::import_storage_year' => __('Importa todas as linhas de CSV Cecad em storage para o ano indicado (ficheiro nacional ou vários municipais).'),
            'cadastro::import_csv' => __('Importa CSV Cecad enviado pelo admin (upload) para cadunico_municipio_snapshots.'),
            'cadastro::auto_sync' => __('Sem upload: descarrega CSV nacional da URL configurada, importa todos os municípios do ficheiro e preenche lacunas via API/CKAN.'),
