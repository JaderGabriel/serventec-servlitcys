    ...
    public function build(
        ...
        if ($rows->isEmpty()) {
            return [
                ...
                'nota' => __('Importe agregados por bairro, setor censitário ou território CRAS: Admin → CadÚnico, `cadunico:pull-territorio` (URL) ou `cadunico:import-territorio` (arquivo local).'),
            ];
        }
