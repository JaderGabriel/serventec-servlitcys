...
final class HorizonteImportHubStatusServiceTest extends TestCase
{
    public function test_build_returns_horizonte_hub_structure(): void
    {
        ...
        $this->assertCount(17, $status['phases']);
        ...
        $procurement = collect($status['phases'])->firstWhere('key', 'procurement_sync');
        ...
        $this->assertStringContainsString('horizonte:sync-procurement', (string) ($procurement['cli'] ?? ''));
