...
| Roadmaps (catálogo `ROADMAP_*`) | [ROADMAP_INDICE.md](ROADMAP_INDICE.md) |
| Canteiro — obras educação | [ROADMAP_CANTEIRO.md](ROADMAP_CANTEIRO.md) |
...
| Orquestração externa (n8n) | [ORQUESTRACAO_EXTERNA_N8N_E_FERRAMENTAS.md](ORQUESTRACAO_EXTERNA_N8N_E_FERRAMENTAS.md) |
| Pulse e saúde de módulos | [MONITOR_PULSE_E_SAUDE_MODULOS.md](MONITOR_PULSE_E_SAUDE_MODULOS.md) |
