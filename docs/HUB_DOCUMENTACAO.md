...
**Versão do produto:** 5.5.0 · **Última revisão:** 2026-06-19
...
Mapa visual da documentação em produção: versão actual **5.5.0**, linha **5.x** (Horizonte GIS + operação admin), navegação da consultoria e convenção de tags. Este ficheiro está versionado no GitHub e no leitor **Documentação** (`/admin/documentacao` e `/documentacao`).
...
| Indicador | Valor |
|-----------|-------|
| **Versão semântica** | **5.5.0** |
| **Tag de deploy** | `20260619c-Helios` |
| **Data de referência** | 2026-06-19 |
| **Release** | [RELEASE_20260619c_HELIOS.md](RELEASE_20260619c_HELIOS.md) |
| **Marco** | **Helios** — Horizonte GIS gerencial + monitor 10 min + catálogo Artisan |
