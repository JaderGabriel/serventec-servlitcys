...
**Versão do produto:** 5.6.0 · **Última revisão:** 2026-06-20
...
Mapa visual da documentação em produção: versão actual **5.6.0**, linha **5.x** (Horizonte GIS + operação admin), navegação da consultoria e convenção de tags. Este ficheiro está versionado no GitHub e no leitor **Documentação** (`/admin/documentacao` e `/documentacao`).
...
| **Tag de deploy** | `20260620-Urania` |
| **Data de referência** | 2026-06-20 |
| **Release** | [RELEASE_20260620_URANIA.md](RELEASE_20260620_URANIA.md) |
| **Marco** | **Urania** — Horizonte alta pressão GIS + feed robusto + sync BR |
