...
O roadmap canónico do Horizonte (ondas, IDs `HOR-*`, ordem de implementação) está em **[ROADMAP_HORIZONTE.md](ROADMAP_HORIZONTE.md)**.

Panorama transversal: [ROADMAP_INDICE.md](ROADMAP_INDICE.md) · Canteiro (obras): [ROADMAP_CANTEIRO.md](ROADMAP_CANTEIRO.md) · Backlog: [BACKLOG_IMPLEMENTACOES.md](BACKLOG_IMPLEMENTACOES.md) § J.
