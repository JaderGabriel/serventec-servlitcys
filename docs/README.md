...
**Versão do produto:** 9.0.1 · tag `20260725-Tyche` · **Última revisão:** 2026-07-25
...
| [ORQUESTRACAO_EXTERNA_N8N_E_FERRAMENTAS.md](ORQUESTRACAO_EXTERNA_N8N_E_FERRAMENTAS.md) | n8n, webhooks, Slack, Sentry, Grafana — desenho e práticas *(admin)* |
