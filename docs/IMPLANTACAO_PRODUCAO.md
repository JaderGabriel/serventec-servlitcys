...
**Versão em produção:** **2.3.8.6** (mapa Início RX + contato municipal; tag `20260521-Mercury` inalterada) · **Última atualização:** 21/05/2026 · [HISTORICO_VERSOES.md](HISTORICO_VERSOES.md) · [PERFORMANCE.md](PERFORMANCE.md)
