...
## Atualização pós-3.10.0 (incorporada na 4.0.0)

> Rebuild Tempo Real e exclusão de totais UF: ver [RELEASE_20260604_HESTIA.md](RELEASE_20260604_HESTIA.md).

## Atualização pós-3.10.0 (nota histórica)
