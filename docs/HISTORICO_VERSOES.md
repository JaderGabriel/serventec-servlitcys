...
|--------|--------|---|-------------|--------|
| **▶ 4.4.4** | `6ea5002` / `20260609c-Atropos` → `main` | **359** | 09/06/2026 | **Produção:** dock analytics, Diagnóstico explorar, cache mapa Início 1 h, PNG com legenda 1/2 colunas, PDF CadÚnico — [RELEASE_20260609c_ATROPOS.md](RELEASE_20260609c_ATROPOS.md). |
