...
**Versão em produção:** **9.0.3** · release `20260806a-Polyhymnia` · **Ramo:** `main` · **Última revisão:** 2026-08-06
...
| **Clio** — coletas Educacenso CSV (menu Clio, export, bloco RX) | Implementado (S1–S6) — [ROADMAP_CLIO.md](ROADMAP_CLIO.md) · [MODULO_CLIO.md](modulos/MODULO_CLIO.md) |
...
| **Clio** — coletas Educacenso 1ª etapa (CSV/ZIP, INF-* incl. DEM/DIS/DEN, cruzamento i-Educar, export CSV/PDF/Excel, Diagnóstico Geral, PDF gestor, bloco RX, BI `bi_clio_*` + painel Insights nativo) | Implementado (S1–S7; 8.2.0+) — [ROADMAP_CLIO.md](ROADMAP_CLIO.md) · [MODULO_CLIO.md](modulos/MODULO_CLIO.md) · próximo S8 promote |
