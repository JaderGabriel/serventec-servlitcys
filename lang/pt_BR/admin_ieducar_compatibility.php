...
return [
    'page' => [
        'subtitle' => 'Verifica se a base escolar do município está alinhada ao Censo, estima impactos no FUNDEB e importa índices oficiais do FNDE (VAAF e VAAT).',
        'hub_description' => 'Use o guia abaixo para entender cada bloco. O probe corre na hora; importações FUNDEB e export JSON vão para a fila em segundo plano.',
    ],

    'guide' => [
        'title' => 'Guia rápido (leitura para gestores)',
        'what_is' => 'Esta tela reúne três funções: (1) testar a ligação ao banco i-Educar do município; (2) importar valores de referência do FUNDEB publicados pelo FNDE; (3) ver pendências de cadastro que podem afetar repasses e o Censo.',
    ...
    'steps' => [
        ...
        '3' => '3. Conferir a tabela VAAF/VAAT e executar «fundeb:diagnose-matriculas» no servidor se VAAF aparecer como piso.',
    ...
    'probe' => [
        ...
        'ano_letivo_hint' => 'Ano letivo para contar matrículas e rotinas. «Todos» consolida vários anos.',
    ...
    'fundeb_card' => [
        'title' => 'Importar índices FUNDEB (VAAF e VAAT)',
        'intro' => 'A importação lê portarias e dados abertos do FNDE e grava na base local o índice por município (VAAF), o VAAT quando publicado e a receita total usada nos cálculos. Tarefas longas vão para a fila — acompanhe até «concluído».',
    ...
    'official_sources' => [
        ...
        'intro' => 'Links das publicações federais que alimentam a importação de VAAF/VAAT e a comparação «Tempo Real» na consultoria. São documentos públicos do FNDE e do INEP — não são gerados pelo SERVLITCYS.',
    ...
    'matrix' => [
        'title' => 'Tabela VAAF e VAAT — todos os municípios (:from–:to)',
        'intro' => 'Cada par de colunas é um exercício FUNDEB (ano da portaria). VAAF = valor por aluno usado nas projeções; VAAT = índice ampliado quando a portaria trouxer o dado.',
