...
use App\Http\Controllers\Clio\CampaignAnalysisController;
use App\Http\Controllers\Clio\CampaignConsultancyController;
use App\Http\Controllers\Clio\CampaignController;
use App\Http\Controllers\Clio\CampaignDriveController;
use App\Http\Controllers\Clio\CampaignExportController;
use App\Http\Controllers\Clio\CampaignInsightsController;
use App\Http\Controllers\Clio\CampaignUploadController;
use App\Http\Controllers\Clio\CatalogCityController;
use App\Http\Controllers\Clio\HomeController;
...
Route::middleware(['auth', 'verified', 'profile.complete'])->group(function () {
    ...
    Route::middleware('legal.consent')->group(function () {
        ...
        Route::prefix('clio')->name('clio.')->group(function () {
            ...
            Route::get('/coletas', [CampaignController::class, 'index'])->name('campaigns.index');
            Route::get('/coletas/nova', [CampaignController::class, 'create'])->name('campaigns.create');
            Route::post('/coletas', [CampaignController::class, 'store'])->name('campaigns.store');
            Route::get('/coletas/{campaign}', [CampaignController::class, 'show'])->name('campaigns.show');
            Route::get('/coletas/{campaign}/analise', [CampaignAnalysisController::class, 'show'])->name('campaigns.analysis');
            Route::post('/coletas/{campaign}/analisar', [CampaignAnalysisController::class, 'run'])->name('campaigns.analyze');
            Route::get('/coletas/{campaign}/insights', [CampaignInsightsController::class, 'show'])->name('campaigns.insights');
            Route::post('/coletas/{campaign}/insights/refresh', [CampaignInsightsController::class, 'refresh'])->name('campaigns.insights.refresh');
            Route::get('/coletas/{campaign}/escolas/{inep}', [CampaignAnalysisController::class, 'school'])->name('campaigns.school');
            Route::get('/coletas/{campaign}/vincular-ieducar', [CampaignConsultancyController::class, 'editLink'])->name('campaigns.link');
            Route::post('/coletas/{campaign}/vincular-ieducar', [CampaignConsultancyController::class, 'storeLink'])->name('campaigns.link.store');
            Route::get('/coletas/{campaign}/cruzamento', [CampaignConsultancyController::class, 'crossCheck'])->name('campaigns.cross-check');
            Route::post('/coletas/{campaign}/cruzamento', [CampaignConsultancyController::class, 'runCrossCheck'])->name('campaigns.cross-check.run');
            Route::get('/coletas/{campaign}/upload', [CampaignUploadController::class, 'edit'])->name('campaigns.upload');
            Route::post('/coletas/{campaign}/upload', [CampaignUploadController::class, 'store'])->name('campaigns.upload.store');
            Route::post('/coletas/{campaign}/drive', [CampaignDriveController::class, 'updateUrl'])->name('campaigns.drive.update');
            ...
            Route::get('/coletas/{campaign}/export/pdf-final', [CampaignExportController::class, 'pdfFinal'])->name('campaigns.export.pdf-final');
            Route::get('/coletas/{campaign}/export/pdf-mapa-coleta', [CampaignExportController::class, 'pdfMapaColeta'])->name('campaigns.export.pdf-mapa-coleta');
            Route::get('/coletas/{campaign}/serie-matriculas', [CampaignController::class, 'enrollmentSeries'])->name('campaigns.enrollment-series');
            Route::get('/municipios/novo', [CatalogCityController::class, 'create'])->name('cities.create');
            Route::post('/municipios/novo', [CatalogCityController::class, 'store'])->name('cities.store');
        });
