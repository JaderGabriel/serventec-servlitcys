    ...
    <div class="serv-analytics-page py-8">
        <div class="max-w-[1600px] mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            @if ($selectedCity)
                ...
                @endphp
                <div
                    x-data="analyticsTabs(@js(array_keys($tabs)), @js($analyticsInitialTab ?? 'overview'), @js($lazyTabLoading), @js(route('dashboard.analytics.tab', [], false)), @js(\App\Support\Dashboard\AnalyticsTabCatalog::navigationPayload()), @js($filters->toQueryParamsWithCity($selectedCity->id)))"
