...
<div {{ $attributes->merge(['class' => 'flex flex-wrap items-center gap-2']) }} role="list" aria-label="{{ __('Legenda rápida das colunas') }}">
    <span class="text-[10px] font-semibold uppercase tracking-wide text-slate-500 dark:text-slate-400 shrink-0">{{ __('Tons:') }}</span>
