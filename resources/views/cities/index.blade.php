                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                        <thead class="bg-gray-50 dark:bg-gray-900/50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-center text-xs font-medium text-gray-500 dark:text-gray-400 uppercase w-28" title="{{ __('Estado da conexão com o banco (clique no ícone para atualizar)') }}">{{ __('Conexão') }}</th>
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-4 text-sm">
                                        <div class="flex items-center justify-center gap-0.5">
                                            <a
                                                href="{{ route('dashboard.analytics', ['city_id' => $city->id]) }}"
                                                class="inline-flex items-center justify-center rounded-md p-1.5 text-teal-600 hover:bg-teal-50 dark:text-teal-400 dark:hover:bg-teal-950/40 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                                                title="{{ __('Análise') }}"
                                            >
                                            ...
                                            <a
                                                ...
                                                class="inline-flex items-center justify-center rounded-md p-1.5 text-indigo-600 hover:bg-indigo-50 dark:text-indigo-400 dark:hover:bg-indigo-950/40 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                                                title="{{ __('Editar') }}"
                                            >
                                                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
                                            ...
                                            <form
                                                ...
                                                class="inline"
                                                onsubmit="return confirm(@js(__('Remover esta cidade?')));"
                                            >
                                                @csrf
                                                @method('DELETE')
                                                <button
                                                    type="submit"
                                                    class="inline-flex items-center justify-center rounded-md p-1.5 text-red-600 hover:bg-red-50 dark:text-red-400 dark:hover:bg-red-950/40 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 dark:focus:ring-offset-gray-800"
                                                    title="{{ __('Remover') }}"
                                                >
                                                    <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.5" aria-hidden="true">
