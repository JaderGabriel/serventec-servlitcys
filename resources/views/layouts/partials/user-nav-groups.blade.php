        ...
        [
            ...
            'items' => array_values(array_filter([
                ...
                [
                    ...
                    'icon' => 'queue-list',
                    'active' => $req->routeIs(['admin.sync-queue.*', 'sync-queue.*']),
                    'title' => __('Importações, PDFs e agendamentos do sistema.'),
                ],
            ])),
        ],
        [
            ...
            'items' => array_values(array_filter([
                [
                    ...
                    'label' => __('Importação por município'),
                    'icon' => 'squares-2x2',
                    'active' => $req->routeIs('admin.public-data.*') && ! $req->routeIs('admin.horizonte-import.*'),
                    'title' => __('FUNDEB, Censo, repasses e SAEB/IDEB — alimentam Analytics e PDF.'),
                ],
                [
                    ...
                    'title' => __('Pipeline nacional para o mapa de oportunidade.'),
                ],
            ])),
        ],
        [
